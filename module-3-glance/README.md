...
openstack endpoint create --region Region-JKT image public http://controller:9292
openstack endpoint create --region Region-JKT image internal http://controller:9292
openstack endpoint create --region Region-JKT image admin http://controller:9292
```
